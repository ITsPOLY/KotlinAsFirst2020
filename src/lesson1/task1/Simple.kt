 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg + (min * 60) * 0.0002778 + sec * 0.0002778) * 0.0174533
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial + (initial * percent * 0.01) +
